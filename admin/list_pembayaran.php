...
<body>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list mg-t-30">
                        <div class="cmp-tb-hd bcs-hd">
                            ...
                            <p>Tanggal : 29 September, 2021</p>
                            <p>Nama Pengguna : Suradi</p>
                            <p>Nomor Rekening : 000271</p>
                            <p>Nomor SAMB. : 0473</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" placeholder="Stand Meter Bulan Lalu">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" placeholder="Stand Meter Bulan Ini">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" placeholder="Pemakaian">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" placeholder="Biaya Pemeliharaan">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    ...
    <div class="sale-statistic-area mg-t-30">
        <div class="container" style="width:1605px;">
            <div class="row">
                                    ...
                                    <table id="data-table-basic" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Pemakaian</th>
                                                <th>Harga Air 0-20</th>
                                                <th>Harga Air 21-30</th>
                                                <th>Harga Air 30 Keatas</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>5.000</td>
                                                <td>5.000</td>
                                                <td><a href="#"><i class="notika-icon notika-dollar"></i></a> &nbsp; <a href="#"><i class="notika-icon notika-draft"></i></a> &nbsp; <a href="#"><i class="notika-icon notika-trash"></i></a></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>21 September, 2021</td>
