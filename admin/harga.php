                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Harga</h2>
                                        <p>Menu ini berisikan daftar harga pembayaran air. <span class="bread-ntd">Isikan data sesuai dengan ketentuan.</span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
                                <div class="breadcomb-report">
                                    ...
                                    <a href="add_harga" class="btn">Tambah Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table id="data-table-basic" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Golongan</th>
                                                <th>Keterangan</th>
                                                <th>Tarif 0-10 m<small style="font-size:8px;">3</small></th>
                                                <th>Tarif 11-20 m<small style="font-size:8px;">3</small></th>
                                                <th>Tarif >20 m<small style="font-size:8px;">3</small></th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
